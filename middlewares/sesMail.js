...
const transporter = nodemailer.createTransport({
    SES: new AWS.SES({
        region: process.env.AWS_SES_REGION, // Specify your SES region
...
const attachments = [
    {
        filename: 'investain-logowithtext.png',
        path: './public/images/investain-logowithtext.png',
...
// Function to send a trading account creation email
    ...
    <body style="font-family: Rajdhani, sans-serif; background-color: #f7f7f7; color: #4d4d4d; padding: 20px; margin: 0;">
        ...
        <div
            ...
            <div style="padding: 20px; padding-top:50px; padding-bottom:50px; max-width: 600px; margin: 0 auto;">
                ...
                <p style="font-family: Rajdhani, sans-serif;">The documents are now available in  <a href="https://am.investain.com" style="color: red; font-weight: bold;">Portal</a></p>
    ...
    async function sendDocApproveEmail(email, name) {
        try {
    ...
    <body style="font-family: Rajdhani, sans-serif; background-color: #f7f7f7; color: #4d4d4d; padding: 20px; margin: 0;">
        ...
        <div
            ...
            <div style="padding: 20px; padding-top:50px; padding-bottom:50px; max-width: 600px; margin: 0 auto;">
                    ...
                    <p style="font-family: Rajdhani, sans-serif;">I hope this message finds you well.</p>
                    <p style="font-family: Rajdhani, sans-serif;">We are pleased to inform you that the document you submitted has been reviewed and approved. Thank you for your prompt attention and cooperation.</p>
                    <p style="font-family: Rajdhani, sans-serif;">If you need any further assistance or have any questions, please feel free to reach out by replying to this email.</p>
                    <p style="font-family: Rajdhani, sans-serif;">Thank you for choosing INVESTAiN. We look forward to continuing to serve you.</p>
    </div>
            <div
            style=" max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
            <div style="text-align: center; padding-top: 40px;">
        ...
        <table align="center" role="presentation" style="width: 100%; text-align: center;">
            ...
            // Send the email
            const info = await transporter.sendMail(mailOptions);
            console.log('Document Approved email sent: ' + info.response);
            return info.response;
        } catch (error) {
    ...
    async function sendDocRejectEmail(email, name, reason) {
        try {
    ...
    <body style="font-family: Rajdhani, sans-serif; background-color: #f7f7f7; color: #4d4d4d; padding: 20px; margin: 0;">
        ...
        <table align="center" role="presentation" style="width: 100%; text-align: center;">
            ...
            // Send the email
            const info = await transporter.sendMail(mailOptions);
            console.log('Document Reject email sent: ' + info.response);
            return info.response;
        } catch (error) {
            console.error('Error sending Document Reject email:', error);
            return error;
        }
    }

    async function sendReplyTicketEmail(email, subject, reply) {
        try {
    ...
    <body style="font-family: Rajdhani, sans-serif; background-color: #f7f7f7; color: #4d4d4d; padding: 20px; margin: 0;">
        ...
        <div
            ...
            <div style="padding: 20px; padding-top:50px; padding-bottom:50px; max-width: 600px; margin: 0 auto;">
                    <p style="font-family: Rajdhani, sans-serif;">${reply},</p>
                    </div>
            <div
            style=" max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
            <div style="text-align: center; padding-top: 40px;">
        ...
        <table align="center" role="presentation" style="width: 100%; text-align: center;">
            ...
            // Send the email
            const info = await transporter.sendMail(mailOptions);
            console.log('Document reply email sent: ' + info.response);
            return info.response;
        } catch (error) {
            console.error('Error sending Document reply email:', error);
            return error;
        }
    }
...
const orgApplicationSubmissionEmail = async (email, link, customerName) => {
    const mailOptions = {
        from: `"INVESTAiN" <no-reply@investain.com>`,
        to: email,
        subject: 'Your INVESTAiN account application has been submitted',
    ...
    <body style="font-family: Rajdhani, sans-serif; background-color: #f7f7f7; color: #4d4d4d; padding: 20px; margin: 0;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
            <div style="text-align: center; padding: 20px;">
                <a href="https://investain.com" style="text-decoration: none;">
                    <img src="cid:investain_logo" alt="INVESTAiN" style="width: 100px; height: 100px;" />
                </a>
            </div>
        </div>
        ...
        <div style="padding: 20px; padding-top: 50px; padding-bottom: 50px; max-width: 600px; margin: 0 auto;">
            ...
            <p>Thank you for applying for a trading account with <strong>INVESTAiN</strong>.</p>

            <p>Your application has been successfully submitted. To move forward with onboarding, please upload the following required documents:</p>

            <ul>
                <li><strong>Company Documents</strong></li>
                <li><strong>Director KYC Documents:</strong> Valid ID and proof of address</li>
                <li><strong>Shareholder KYC Documents:</strong> Valid ID and proof of address for each shareholder</li>
            </ul>

            <p>To upload your documents:</p>
            <p>
                <a href="${link}" style="color: red; font-weight: bold;">Log in</a> using your email and password that you set during registration.
            </p>

            <p>Once all required documents are uploaded, our compliance team will begin the verification process.</p>
            <p>If you have any questions or need help, feel free to contact our support team.</p>
        </div>

        <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
            <div style="text-align: center; padding-top: 40px;">
                <h3 style="color: #333; font-size: 16px;">Download our App</h3>
            </div>
            <table align="center" role="presentation" style="width: 100%; text-align: center;">
                <tr class="download-app-container">
                    <td>
            ...
            <div style="text-align: center; padding: 20px;">
                <h3 style="color: #333; font-size: 20px;">Contact us</h3>
                <p>For any inquiries please reach us at <strong style="color: red;">support@investain.com</strong></p>
            </div>
    ...
    try {
        const info = await transporter.sendMail(mailOptions);
        console.log('org application success email sent!', info);
        return { success: true, info };
    } catch (error) {
        console.error('Error sending email of org aapplication: ', error);
        return { success: false, error };
    }
};
